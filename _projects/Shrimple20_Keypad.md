...
sections:
  ...
  - text: |
      1. Flashing firmware to the KB2040
      2. KMK modules
      3. KMK extensions
      4. Layers
      5. Media keys
  ...
  - text: |
      The full KMK configuration .py file is also available on my GitHub

  - text: |
      Overall the Shrimple20 Keypad works great, the keys and knob are satisfying and the layers work flawlessly. Next steps for this project would probably be to learn how to use a different microcontroller to enable bluetooth, maybe install a small LCD screen to show diagnostic info, get better keycaps, machine the case out of metal, or develop an entire ergo keyboard.
---
